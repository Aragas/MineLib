...
namespace Aragas.Network.Packets
{
    ...
    /// </summary>
    /// <typeparam name="TDeserializer"><see cref="StreamDeserializer"/>. You can create a custom one or use <see cref="StandardDeserialiser"/> and <see cref="ProtobufDeserializer"/></typeparam>
