...
namespace OpenTerrainGenerator.CustomObjects
{
     ...
     *
     */
    public class CustomObjectCollection : IEnumerable<CustomObject>
    {
        private List<CustomObject> objects;
        private Dictionary<String, CustomObject> objectsByName;
        ...
        {
            this.objects = new List<CustomObject>();
            this.objectsByName = new Dictionary<String, CustomObject>();
        }
         ...
         *                  searched too.
         */
        public CustomObjectCollection(Dictionary<String, CustomObjectLoader> loaders, File directory)
        {
            this();
         ...
         *                  searched too.
         */
        public void load(Dictionary<String, CustomObjectLoader> loaders, File directory)
        {
            ...
            Dictionary<String, CustomObject> objects = loadObjectsRecursive(loaders, directory);
            foreach (CustomObject @object in objects.values())
            {
        ...
        {
            String lowerCaseName = @object.getName().ToLower();
            if (!objectsByName.ContainsKey(lowerCaseName))
            {
                objectsByName[lowerCaseName] = @object;
                objects.Add(@object);
            }
        }
         ...
         */
        private static Dictionary<String, CustomObject> loadObjectsRecursive(Dictionary<String, CustomObjectLoader> loaders, File directory)
        {
            ...
            Dictionary<String, CustomObject> objects = new Dictionary<String, CustomObject>();
        ...
        public override IEnumerable<CustomObject> iterator()
        {
