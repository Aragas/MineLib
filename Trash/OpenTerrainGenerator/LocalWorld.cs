using OpenTerrainGenerator.CustomObjects;
...
namespace OpenTerrainGenerator
{
    ...
    public interface LocalWorld
    {
        ...
        List<LocalBiome> getAllBiomes();

        LocalBiome getBiomeById(int id);

        LocalBiome getBiomeByIdOrNull(int id);

        LocalBiome getBiomeByNameOrNull(String name);
         ...
         */
        LocalBiome getBiome(int x, int z);
         ...
         */
        LocalBiome getSavedBiome(int x, int z);
        ...
        // Default generators
        void prepareDefaultStructures(int chunkX, int chunkZ, bool dry);

        bool placeDungeon(Random rand, int x, int y, int z);

        bool placeFossil(Random rand, ChunkCoordinate chunkCoord);

        //bool placeTree(TreeType type, Random rand, int x, int y, int z);

        bool placeDefaultStructures(Random rand, ChunkCoordinate chunkCoord);
        ...
        //void mergeVanillaBiomeMobSpawnSettings(BiomeConfigStub biomeConfigStub);
